...
| Qwen3.6-35B-A3B (GDN+MoE) | (same) | 22 GB | **CUDA** `-g -1` (hybrid) | **7.3** | **18.0** | 10 attn + 30 GDN on GPU; MoE auto-routed to CPU, shared expert kept on GPU and overlapped with the CPU routed loop |
